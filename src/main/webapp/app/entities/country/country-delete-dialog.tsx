  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterSampleApplicationApp.country.delete.question">
          <Translate contentKey="jhipsterSampleApplicationApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
