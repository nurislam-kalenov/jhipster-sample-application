      ...
      <div>
        <h2 id="country-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationApp.country.home.createLabel">Create a new Country</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {countryList && countryList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.country.home.notFound">No Countries found</Translate>
            </div>
          )}
        </div>
      </div>
