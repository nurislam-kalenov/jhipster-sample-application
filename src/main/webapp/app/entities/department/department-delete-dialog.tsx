  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterSampleApplicationApp.department.delete.question">
          <Translate contentKey="jhipsterSampleApplicationApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
