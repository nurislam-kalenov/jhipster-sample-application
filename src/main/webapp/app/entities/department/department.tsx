    ...
    return (
      <div>
        <h2 id="department-heading">
          <Translate contentKey="jhipsterSampleApplicationApp.department.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationApp.department.home.createLabel">Create a new Department</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {departmentList && departmentList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.department.home.notFound">No Departments found</Translate>
            </div>
          )}
        </div>
      </div>
