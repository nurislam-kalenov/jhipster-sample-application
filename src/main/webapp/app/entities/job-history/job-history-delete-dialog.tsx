  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterSampleApplicationApp.jobHistory.delete.question">
          <Translate contentKey="jhipsterSampleApplicationApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
