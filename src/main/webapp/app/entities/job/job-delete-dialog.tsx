  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterSampleApplicationApp.job.delete.question">
          <Translate contentKey="jhipsterSampleApplicationApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
