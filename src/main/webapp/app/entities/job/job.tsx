      ...
      <div>
        <h2 id="job-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="jhipsterSampleApplicationApp.job.home.createLabel">Create a new Job</Translate>
          </Link>
        </h2>
            ...
            <Table responsive aria-describedby="job-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jhipsterSampleApplicationApp.job.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
